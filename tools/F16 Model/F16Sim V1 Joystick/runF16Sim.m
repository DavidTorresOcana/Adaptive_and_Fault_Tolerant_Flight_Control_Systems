...
F16BlockSYM
return
%% Check the goodness of the Symetric trim
...
disp('Which model would you like to use:')
disp('  1. Symetric model of F-16')
disp('  2. Asymetric model of F-16')
Model_used_flag = input('Your Selection:  ');
if Model_used_flag == 1;
  Model_used_flag = 0;
elseif Model_used_flag == 2;
  Model_used_flag = 1;
else
  disp('Invalid selection');
  break;
